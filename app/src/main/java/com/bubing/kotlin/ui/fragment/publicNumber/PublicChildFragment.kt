...
import com.bubing.kotlin.viewmodel.state.PublicNumberViewModel
import com.bubing.mvvmk.ext.nav
import com.bubing.mvvmk.ext.navigateAction

/**
 * @ClassName: PublicChildFragment
 * @Author: Bubing
 * @Date: 2020/8/10 1:35 PM
 * @Description: 公众号
 */
    ...
    override fun createObserver() {
        ...
        appViewModel.run {
            ...
            appColor.observe(viewLifecycleOwner, Observer {
                setUiTheme(it, floatingActionButton, swipeRefreshLayout, loadsir, footView)
            })
            //监听全局的列表动画改编
