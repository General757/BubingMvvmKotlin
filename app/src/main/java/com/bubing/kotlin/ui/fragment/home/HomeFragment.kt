package com.bubing.kotlin.ui.fragment.home
...
import com.bubing.kotlin.weight.banner.HomeBannerAdapter
import com.bubing.kotlin.weight.banner.HomeBannerViewHolder
...
import com.bubing.kotlin.databinding.FragmentHomeBinding
import com.bubing.kotlin.ui.adapter.AriticleAdapter
import com.bubing.kotlin.viewmodel.request.RequestCollectViewModel
import com.bubing.kotlin.viewmodel.request.RequestHomeViewModel
import com.bubing.kotlin.viewmodel.state.HomeViewModel
        ...
        articleAdapter.run {
            ...
            setOnItemClickListener { adapter, view, position ->
                nav().navigateAction(R.id.action_to_webFragment, Bundle().apply {
                    putParcelable(
                        "ariticleData",
                        articleAdapter.data[position - this@HomeFragment.swipeRecyclerView.headerCount]
                    )
                })
            }
                    ...
                    R.id.item_home_author, R.id.item_project_author -> {
                        nav().navigateAction(
                            ...
                            Bundle().apply {
                                putInt(
                                    "id",
                                    articleAdapter.data[position - this@HomeFragment.swipeRecyclerView.headerCount].userId
                                )
                            })
                    }
                }
    ...
    override fun createObserver() {
        ...
        appViewModel.run {
            ...
            appColor.observe(viewLifecycleOwner, Observer {
                setUiTheme(it, toolbar, floatingActionButton, swipeRefreshLayout, loadsir, footView)
            })
            //监听全局的列表动画改编
