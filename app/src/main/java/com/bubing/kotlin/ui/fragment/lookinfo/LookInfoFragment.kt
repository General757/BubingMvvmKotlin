package com.bubing.kotlin.ui.fragment.lookinfo
...
import com.bubing.kotlin.databinding.FragmentLookinfoBinding
import com.bubing.kotlin.ui.adapter.AriticleAdapter
import com.bubing.kotlin.viewmodel.request.RequestCollectViewModel
import com.bubing.kotlin.viewmodel.request.RequestLookInfoViewModel
import com.bubing.kotlin.viewmodel.state.LookInfoViewModel
...
/**
 * @ClassName: LookInfoFragment
 * @Author: Bubing
 * @Date: 2020/8/11 3:04 PM
 * @Description: 查看他人信息
 */
        ...
        articleAdapter.run {
            ...
            setOnItemClickListener { adapter, view, position ->
                nav().navigateAction(R.id.action_to_webFragment, Bundle().apply {
                    putParcelable(
                        "ariticleData",
                        articleAdapter.data[position - this@LookInfoFragment.swipeRecyclerView.headerCount]
                    )
                })
            }
        }
